    ...
    <main className="pt-20">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="text-[#4F46E5] text-sm font-semibold uppercase tracking-wider mb-3">
                Who We Are
              </p>
              <h2 className="text-3xl md:text-4xl font-bold text-[#111827] mb-6 font-display">
              ...
              <p className="text-[#6B7280] leading-relaxed mb-6 font-body">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  >
                    <div className="text-2xl font-bold text-[#4F46E5] font-display">
                      {value}
                    </div>
      ...
      <section className="py-20 bg-[#F8FAFC]">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-indigo-50 text-[#4F46E5] text-sm px-4 py-2 rounded-full mb-4 font-medium border border-indigo-100">
              <Users className="w-4 h-4" />
              Leadership
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-[#111827] font-display">
          ...
          >
            <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
              ...
              <div className="flex-1 text-center md:text-left">
                <div className="inline-flex items-center gap-2 bg-cyan-50 text-[#06B6D4] text-xs px-3 py-1 rounded-full mb-3 font-medium border border-cyan-100">
                  <Award className="w-3 h-3" />
                  Founder & Director
                </div>
                <h3 className="text-2xl md:text-3xl font-bold text-[#111827] mb-1 font-display">
                  Suryavanshi Kumar
                </h3>
                <p className="text-[#4F46E5] font-semibold mb-1">
                  "Yashu Lucky"
                </p>
                ...
                <p className="text-[#6B7280] leading-relaxed mb-5 font-body">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v, i) => (
              ...
              >
                <div className="w-10 h-10 bg-indigo-100 group-hover:gradient-primary rounded-xl flex items-center justify-center mb-3 transition-all duration-300">
                  <v.icon className="w-5 h-5 text-[#4F46E5] group-hover:text-white transition-colors" />
                </div>
                <h4 className="font-bold text-[#111827] mb-2 font-display">
                  {v.title}
                </h4>
                <p className="text-[#6B7280] text-sm font-body">{v.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="relative">
            ...
            {milestones.map((milestone, i) => (
              ...
              >
                {/* Content */}
                <div
                  className={`flex-1 bg-white rounded-2xl p-5 shadow-card border border-[#E5E7EB] ml-10 md:ml-0 hover:border-[#4F46E5]/30 transition-colors ${
                    i % 2 === 0 ? "md:mr-12" : "md:ml-12"
                  }`}
                >
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-[#4F46E5] font-bold text-lg font-display">
                      {milestone.year}
                    </span>
                  </div>
                ...
                {/* Dot */}
                <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 top-5 w-4 h-4 gradient-primary rounded-full shadow-md ring-4 ring-white" />
              </motion.div>
            ))}
          </div>
        </div>
